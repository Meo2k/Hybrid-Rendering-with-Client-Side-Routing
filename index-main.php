...
header("Location: /hybrid_rendering/index.php");
exit;
}
?>
<!DOCTYPE html>
    ...
    <div id="app">
        ...
        padding: 0 5px;">
            <ul>
                ...
                <li><a href="/hybrid_rendering/dashboard" data-route>Me</a></li>
            </ul>
            <ul>
                <button><a href="/hybrid_rendering/logout" data-route>Log out</a></button>
            </ul>
        </nav>
